...
class WebhookConfigDeleteResponseDTO(BaseModel):
    """
    WebhookConfigDeleteResponseDTO
    """ # noqa: E501
    deleted: Optional[StrictBool] = Field(default=None, description="Indica se o Webhook foi removido")
    id: Optional[StrictStr] = Field(default=None, description="Identificador único do webhook removido")
