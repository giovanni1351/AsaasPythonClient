...
class NotificationBatchUpdateResponseDTO(BaseModel):
    """
    NotificationBatchUpdateResponseDTO
    """ # noqa: E501
    notifications: Optional[List[NotificationGetResponseDTO]] = Field(default=None, description="Lista de informações das notificações")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "notifications": [NotificationGetResponseDTO.from_dict(_item) for _item in obj["notifications"]] if obj.get("notifications") is not None else None
        })
        return _obj
