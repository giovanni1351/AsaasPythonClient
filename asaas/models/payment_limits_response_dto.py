...
class PaymentLimitsResponseDTO(BaseModel):
    """
    PaymentLimitsResponseDTO
    """ # noqa: E501
    creation: Optional[PaymentLimitsResponseCreationDTO] = None
    __properties: ClassVar[List[str]] = ["creation"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "creation": PaymentLimitsResponseCreationDTO.from_dict(obj["creation"]) if obj.get("creation") is not None else None
        })
        return _obj
