...
class ErrorResponseItemDTO(BaseModel):
    """
    Lista de objetos
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="Código do erro")
    description: Optional[StrictStr] = Field(default=None, description="Descrição do erro")
