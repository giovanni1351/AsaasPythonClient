...
class PaymentLimitsResponseCreationDTO(BaseModel):
    """
    Limites de criação
    """ # noqa: E501
    daily: Optional[PaymentLimitsResponseCreationDailyDTO] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "daily": PaymentLimitsResponseCreationDailyDTO.from_dict(obj["daily"]) if obj.get("daily") is not None else None
        })
        return _obj
