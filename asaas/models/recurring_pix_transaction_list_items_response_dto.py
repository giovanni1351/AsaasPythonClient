...
class RecurringPixTransactionListItemsResponseDTO(BaseModel):
    """
    RecurringPixTransactionListItemsResponseDTO
    """ # noqa: E501
    data: Optional[List[PixRecurringTransactionGetItemResponseDTO]] = Field(default=None, description="Lista de objetos")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [PixRecurringTransactionGetItemResponseDTO.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
