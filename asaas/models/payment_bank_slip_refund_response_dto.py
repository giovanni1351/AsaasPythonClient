...
class PaymentBankSlipRefundResponseDTO(BaseModel):
    """
    PaymentBankSlipRefundResponseDTO
    """ # noqa: E501
    request_url: Optional[StrictStr] = Field(default=None, description="Link para informar os dados de estorno", alias="requestUrl")
    __properties: ClassVar[List[str]] = ["requestUrl"]
