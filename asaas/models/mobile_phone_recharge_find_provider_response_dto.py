...
class MobilePhoneRechargeFindProviderResponseDTO(BaseModel):
    """
    MobilePhoneRechargeFindProviderResponseDTO
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Nome da operadora do celular")
    values: Optional[List[MobilePhoneRechargeFindProviderResponseValuesDTO]] = Field(default=None, description="Valores disponíveis para recarga")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "values": [MobilePhoneRechargeFindProviderResponseValuesDTO.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
