...
class PaymentInterestRequestDTO(BaseModel):
    """
    Informações de juros para pagamento após o vencimento
    """ # noqa: E501
    value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Percentual de juros *ao mês* sobre o valor da cobrança para pagamento após o vencimento")
