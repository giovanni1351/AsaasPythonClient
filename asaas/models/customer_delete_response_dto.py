...
class CustomerDeleteResponseDTO(BaseModel):
    """
    CustomerDeleteResponseDTO
    """ # noqa: E501
    deleted: Optional[StrictBool] = Field(default=None, description="Indica se o cliente foi removido")
    id: Optional[StrictStr] = Field(default=None, description="Identificador único do cliente")
