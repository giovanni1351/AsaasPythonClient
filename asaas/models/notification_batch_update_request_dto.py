...
class NotificationBatchUpdateRequestDTO(BaseModel):
    """
    NotificationBatchUpdateRequestDTO
    """ # noqa: E501
    customer: StrictStr = Field(description="Identificador único do cliente no Asaas")
    notifications: Optional[List[NotificationBatchUpdateItemRequestDTO]] = Field(default=None, description="Lista de informações das notificações")
    __properties: ClassVar[List[str]] = ["customer", "notifications"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "notifications": [NotificationBatchUpdateItemRequestDTO.from_dict(_item) for _item in obj["notifications"]] if obj.get("notifications") is not None else None
        })
        return _obj
