...
class InstallmentUpdateSplitRequestDTO(BaseModel):
    """
    InstallmentUpdateSplitRequestDTO
    """ # noqa: E501
    splits: Optional[List[InstallmentSplitRequestDTO]] = Field(default=None, description="Dados de split para atualizar")
