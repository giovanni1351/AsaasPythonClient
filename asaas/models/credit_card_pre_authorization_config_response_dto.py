...
class CreditCardPreAuthorizationConfigResponseDTO(BaseModel):
    """
    CreditCardPreAuthorizationConfigResponseDTO
    """ # noqa: E501
    days_to_expire: StrictInt = Field(description="Quantidade de dias para expiração da pré-autorização", alias="daysToExpire")
    __properties: ClassVar[List[str]] = ["daysToExpire"]
