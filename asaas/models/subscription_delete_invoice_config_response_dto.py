...
class SubscriptionDeleteInvoiceConfigResponseDTO(BaseModel):
    """
    SubscriptionDeleteInvoiceConfigResponseDTO
    """ # noqa: E501
    deleted: Optional[StrictBool] = Field(default=None, description="Informa se as configurações foram removidas")
