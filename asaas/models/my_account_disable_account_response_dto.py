...
class MyAccountDisableAccountResponseDTO(BaseModel):
    """
    MyAccountDisableAccountResponseDTO
    """ # noqa: E501
    observations: Optional[StrictStr] = Field(default=None, description="Informações sobre a exclusão")
    __properties: ClassVar[List[str]] = ["observations"]
