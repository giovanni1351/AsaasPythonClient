...
class MyAccountGetAccountFeesPaymentDunningDTO(BaseModel):
    """
    Taxas de negativação Serasa
    """ # noqa: E501
    fee_value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Taxa por cobrança", alias="feeValue")
