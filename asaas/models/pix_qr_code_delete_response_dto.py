...
class PixQrCodeDeleteResponseDTO(BaseModel):
    """
    PixQrCodeDeleteResponseDTO
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Identificador do QrCode")
    deleted: Optional[StrictBool] = Field(default=None, description="Indica se o QR Code foi removido")
