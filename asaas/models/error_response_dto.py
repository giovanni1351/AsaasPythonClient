...
class ErrorResponseDTO(BaseModel):
    ...
    ErrorResponseDTO
    """ # noqa: E501
    errors: Optional[List[ErrorResponseItemDTO]] = Field(default=None, description="Lista de objetos")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "errors": [ErrorResponseItemDTO.from_dict(_item) for _item in obj["errors"]] if obj.get("errors") is not None else None
        })
        return _obj
