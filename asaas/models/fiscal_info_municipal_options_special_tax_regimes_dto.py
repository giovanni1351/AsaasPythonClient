...
class FiscalInfoMunicipalOptionsSpecialTaxRegimesDTO(BaseModel):
    """
    Opções de regime especial de tributação
    """ # noqa: E501
    label: Optional[StrictStr] = Field(default=None, description="Nome do regime especial de tributação")
    value: Optional[StrictStr] = Field(default=None, description="Identificador do regime especial de tributação")
