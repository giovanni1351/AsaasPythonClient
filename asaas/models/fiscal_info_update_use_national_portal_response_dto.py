...
class FiscalInfoUpdateUseNationalPortalResponseDTO(BaseModel):
    """
    FiscalInfoUpdateUseNationalPortalResponseDTO
    """ # noqa: E501
    success: Optional[StrictBool] = Field(default=None, description="Estado da requisição para alteração da habilitação do uso do portal nacional para emissão de notas fiscais.")
