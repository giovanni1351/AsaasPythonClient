...
class FiscalInfoUpdateUseNationalPortalRequestDTO(BaseModel):
    """
    FiscalInfoUpdateUseNationalPortalRequestDTO
    """ # noqa: E501
    enabled: StrictBool = Field(description="Indica se a emissão de notas fiscais pelo portal nacional deve ser habilitada ou não.")
