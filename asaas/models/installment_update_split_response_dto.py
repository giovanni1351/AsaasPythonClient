...
class InstallmentUpdateSplitResponseDTO(BaseModel):
    """
    InstallmentUpdateSplitResponseDTO
    """ # noqa: E501
    splits: Optional[List[InstallmentSplitGetResponseDTO]] = Field(default=None, description="Array de splits")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "splits": [InstallmentSplitGetResponseDTO.from_dict(_item) for _item in obj["splits"]] if obj.get("splits") is not None else None
        })
        return _obj
