...
class PaymentRefundSplitRequestDTO(BaseModel):
    """
    Estorno de splits
    """ # noqa: E501
    id: StrictStr = Field(description="Identificador único do split no Asaas")
    value: Union[StrictFloat, StrictInt] = Field(description="Valor a ser estornado do split")
