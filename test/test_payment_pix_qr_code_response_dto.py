...
class TestPaymentPixQrCodeResponseDTO(unittest.TestCase):
    """PaymentPixQrCodeResponseDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaymentPixQrCodeResponseDTO:
        """Test PaymentPixQrCodeResponseDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaymentPixQrCodeResponseDTO`
        """
        model = PaymentPixQrCodeResponseDTO()
        if include_optional:
            return PaymentPixQrCodeResponseDTO(
    ...
    def testPaymentPixQrCodeResponseDTO(self):
        """Test PaymentPixQrCodeResponseDTO"""
